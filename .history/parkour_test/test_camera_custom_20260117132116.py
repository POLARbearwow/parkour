...
# 导入BASE_LINK_NAME配置
from parkour_tasks.default_cfg_custom import BASE_LINK_NAME
...
CAMERA_CFG = CameraCfg(
    # 修改：使用dogV2的base link名称（根据USD文件调整）
    prim_path="{ENV_REGEX_NS}/Robot/DOGV2_2_4_SLDASM_base_link/front_cam",
    height=60,
    width=106,
    history_length = 2,
...
CAMERA_USD_CFG = AssetBaseCfg(
    # 修改：使用dogV2的base link名称（根据USD文件调整）
    prim_path="{ENV_REGEX_NS}/Robot/DOGV2_2_4_SLDASM_base_link/d435",
